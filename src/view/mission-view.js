      ...
      <div class="mission__wrapper">
        ...
        <div class="mission__content">
          ...
          <div class="mission__img">
            <picture>
              <source type="image/webp" srcset="img/content/mission.webp, img/content/mission@2x.webp 2x">
              <img src="img/content/mission.png" srcset="img/content/mission@2x.png 2x" width="623" height="623" alt="букет">
            </picture>
          </div>
        </div>
      </div>
