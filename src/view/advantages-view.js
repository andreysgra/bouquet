    ...
    <div class="container">
      <div class="advantages__wrapper">
        <div class="advantages__img">
          <picture>
            <source type="image/webp" srcset="img/content/flor-saurina.webp, img/content/flor-saurina@2x.webp 2x">
            <img src="img/content/flor-saurina.png" srcset="img/content/flor-saurina@2x.png 2x" width="1044" height="810" alt="букет">
          </picture>
        </div>
